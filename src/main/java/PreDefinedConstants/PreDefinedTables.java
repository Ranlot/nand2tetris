...
abstract public class PreDefinedTables {
    ...
    public static final Multimap<String, String> computeTableContent = new ImmutableMultimap.Builder<String, String>()
            .put("0", "101010")
            .put("1", "111111")
            .put("-1", "111010")
            .put("D", "001100")
            ...
            .put("1+A", "110111")
            .put("A+1", "110111") //same as 1+A
            .put("1+M", "110111")
            .put("M+1", "110111") //same as 1+M
            .put("1-D", "001110")
            .put("D-1", "001110") //same as 1-D
            .put("1-A", "110010")
            .put("A-1", "110010") //same as 1-A
            .put("1-M", "110010")
            .put("M-1", "110010") //same as 1-M
            .put("D+A", "000010")
            .put("A+D", "000010") //same as D+A
            .put("D+M", "000010")
            .put("M+D", "000010") //same as D+M
            .put("D-A", "010011")
            .put("A-D", "010011") //same as D-A
            .put("D-M", "010011")
            .put("M-D", "010011") //same as D-M
            .put("A-D", "000111")
            .put("D-A", "000111") //same as A-D
            .put("M-D", "000111")
            .put("D-M", "000111") //same as M-D
            .put("D&A", "000000")
